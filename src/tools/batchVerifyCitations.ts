...
import type { NormalizedPaper, BatchCitationInput } from '../types.js';
...
async function verifySingleCitation(citation: BatchCitationInput): Promise<any> {
...
export async function batchVerifyCitations(input: { citations: BatchCitationInput[] }): Promise<{
